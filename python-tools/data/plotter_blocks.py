...
output_path = data_path.parent / "scatter_plot_blocks.html"
...
# Create scatter plot: Power vs Total Blocks
fig = go.Figure(data=go.Scatter(
    ...
    text=df["file"],
    hovertemplate="<b>%{text}</b><br>Total Blocks: %{x}<br>Power: %{y:.2f} J<extra></extra>",
))

fig.update_layout(
    title="Power Consumption vs Total Blocks",
    xaxis_title="Total Blocks (blockDim * gridDim)",
