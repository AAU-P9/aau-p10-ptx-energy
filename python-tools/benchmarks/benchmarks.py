...
def main() -> None:
    ...
    run_benchmarks(
        ...
        program_path=Path(
            "/home/lasse/aau-p10-ptx-energy/apps/flip_flop_mha"
        ),
    ...
    bt_apps = Path("/home/lasse/aau-p10-ptx-energy/apps")
    ...
    run_benchmarks(
        ...
        sizes=[24],  # [24, 25, 28]
        program_path=Path(
            "/home/lasse/aau-p10-ptx-energy/apps/npb_ep_kernel/src"
        ),
        nvcc_args_builder=lambda size: [
            f"-DM_EP={size}",
            "-DITERATIONS=50",
    ...
    cg_apps = Path("/home/lasse/aau-p10-ptx-energy/apps")
    ...
    ft_apps = Path("/home/lasse/aau-p10-ptx-energy/apps")
    ...
    is_apps = Path("/home/lasse/aau-p10-ptx-energy/apps")
    ...
    lu_apps = Path("/home/lasse/aau-p10-ptx-energy/apps")
    ...
    mg_apps = Path("/home/lasse/aau-p10-ptx-energy/apps")
    ...
    sp_apps = Path("/home/lasse/aau-p10-ptx-energy/apps")
    ...
    run_benchmarks(
        ...
        program_path=Path(
            "/home/lasse/aau-p10-ptx-energy/apps/matrix_transpose/src"
        ),
    ...
    # pair_benchmarks = Path("/home/lasse/aau-p10-ptx-energy/apps")
    # pair_sizes = [1]
