; ModuleID = '/tmp/tmpjqj88ka9/main_injected.cu'
source_filename = "/tmp/tmpjqj88ka9/main_injected.cu"
...
@.str.32 = private unnamed_addr constant [44 x i8] c"[LOG] Running kernel with %d iterations...\0A\00", align 1
@.str.33 = private unnamed_addr constant [63 x i8] c"[LOG] Launching kernel with grid size %d and block size %d...\0A\00", align 1
@.str.34 = private unnamed_addr constant [50 x i8] c"[LOG] Kernel launched. Waiting for completion...\0A\00", align 1
@.str.35 = private unnamed_addr constant [61 x i8] c"[ERROR] Failed to launch vector_add kernel (error code %s)!\0A\00", align 1
...
@.str.40 = private unnamed_addr constant [19 x i8] c"kernel_params.json\00", align 1
@.str.41 = private unnamed_addr constant [77 x i8] c"[OFFSET] CUPTI Timestamp: %lu, CPU Timestamp #1: %lu, CPU Timestamp #2: %lu\0A\00", align 1
@__const._Z23collectTimestampOffsetsv.sleepTime = private unnamed_addr constant %struct.timespec { i64 0, i64 10000000 }, align 8
@.str.42 = private unnamed_addr constant [26 x i8] c"[KERNEL] Start Time: %lu\0A\00", align 1
@.str.43 = private unnamed_addr constant [24 x i8] c"[KERNEL] End Time: %lu\0A\00", align 1
@.str.44 = private unnamed_addr constant [24 x i8] c"[KERNEL] Duration: %lu\0A\00", align 1
...
define dso_local void @madsen_function(ptr noundef %0, ptr noundef %1) #1 personality ptr @__gxx_personality_v0 {
  ...
  store ptr @.str.37, ptr %53, align 8
...
52:                                               ; preds = %27
  ...
  %54 = call noundef i32 @_ZL10cudaMallocIfE9cudaErrorPPT_m(ptr noundef %8, i64 noundef %53)
  %55 = load i64, ptr %3, align 8
  %56 = call noundef i32 @_ZL10cudaMallocIfE9cudaErrorPPT_m(ptr noundef %9, i64 noundef %55)
  %57 = load i64, ptr %3, align 8
  %58 = call noundef i32 @_ZL10cudaMallocIfE9cudaErrorPPT_m(ptr noundef %10, i64 noundef %57)
  %59 = load ptr, ptr %8, align 8
  %60 = load ptr, ptr %4, align 8
  %61 = load i64, ptr %3, align 8
  %62 = call i32 @cudaMemcpy(ptr noundef %59, ptr noundef %60, i64 noundef %61, i32 noundef 1)
  %63 = load ptr, ptr %9, align 8
  %64 = load ptr, ptr %5, align 8
  %65 = load i64, ptr %3, align 8
  %66 = call i32 @cudaMemcpy(ptr noundef %63, ptr noundef %64, i64 noundef %65, i32 noundef 1)
  %67 = call i32 (ptr, ...) @printf(ptr noundef @.str.32, i32 noundef 10000000)
  ...
  %76 = call i32 (ptr, ...) @printf(ptr noundef @.str.33, i32 noundef %74, i32 noundef %75)
  %77 = load i32, ptr %12, align 4
  call void @_ZN4dim3C2Ejjj(ptr noundef nonnull align 4 dereferenceable(12) %13, i32 noundef %77, i32 noundef 1, i32 noundef 1)
  %78 = load i32, ptr %11, align 4
  call void @_ZN4dim3C2Ejjj(ptr noundef nonnull align 4 dereferenceable(12) %14, i32 noundef %78, i32 noundef 1, i32 noundef 1)
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %15, ptr align 4 %13, i64 12, i1 false)
  %79 = getelementptr inbounds { i64, i32 }, ptr %15, i32 0, i32 0
  %80 = load i64, ptr %79, align 4
  %81 = getelementptr inbounds { i64, i32 }, ptr %15, i32 0, i32 1
  %82 = load i32, ptr %81, align 4
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %16, ptr align 4 %14, i64 12, i1 false)
  %83 = getelementptr inbounds { i64, i32 }, ptr %16, i32 0, i32 0
  %84 = load i64, ptr %83, align 4
  %85 = getelementptr inbounds { i64, i32 }, ptr %16, i32 0, i32 1
  %86 = load i32, ptr %85, align 4
  %87 = call i32 @__cudaPushCallConfiguration(i64 %80, i32 %82, i64 %84, i32 %86, i64 noundef 0, ptr noundef null)
  %88 = icmp ne i32 %87, 0
...
89:                                               ; preds = %52
  ...
  call void @_Z25__device_stub__vector_addPfS_S_i(ptr noundef %90, ptr noundef %91, ptr noundef %92, i32 noundef %93) #19
  br label %94

94:                                               ; preds = %89, %52
  %95 = call i32 (ptr, ...) @printf(ptr noundef @.str.34)
  %96 = call i32 @cudaGetLastError()
...
99:                                               ; preds = %94
  ...
  %101 = call ptr @cudaGetErrorString(i32 noundef %100)
  %102 = call i32 (ptr, ...) @printf(ptr noundef @.str.35, ptr noundef %101)
...
103:                                              ; preds = %94
  ...
  %107 = call i32 @cudaMemcpy(ptr noundef %104, ptr noundef %105, i64 noundef %106, i32 noundef 2)
  call void @_Z17flushCUPTIBuffersv()
  call void @_Z17printKernelTimingv()
  %108 = load ptr, ptr %8, align 8
  %109 = call i32 @cudaFree(ptr noundef %108)
  %110 = load ptr, ptr %9, align 8
  %111 = call i32 @cudaFree(ptr noundef %110)
  %112 = load ptr, ptr %10, align 8
  %113 = call i32 @cudaFree(ptr noundef %112)
...
11:                                               ; preds = %8
  ...
  %30 = call i32 (ptr, ...) @printf(ptr noundef @.str.41, i64 noundef %27, i64 noundef %28, i64 noundef %29)
...
3:                                                ; preds = %0
  ...
  %5 = call i32 (ptr, ...) @printf(ptr noundef @.str.42, i64 noundef %4)
  %6 = load i64, ptr @_ZL8end_time, align 8
  %7 = call i32 (ptr, ...) @printf(ptr noundef @.str.43, i64 noundef %6)
