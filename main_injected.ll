; ModuleID = '/tmp/tmptbvk9or6/main_injected.cu'
source_filename = "/tmp/tmptbvk9or6/main_injected.cu"
...
@.str.31 = private unnamed_addr constant [44 x i8] c"[LOG] Running kernel with %d iterations...\0A\00", align 1
@.str.32 = private unnamed_addr constant [2 x i8] c"a\00", align 1
@.str.33 = private unnamed_addr constant [2 x i8] c"b\00", align 1
@.str.34 = private unnamed_addr constant [4 x i8] c"out\00", align 1
@.str.35 = private unnamed_addr constant [2 x i8] c"N\00", align 1
@.str.36 = private unnamed_addr constant [19 x i8] c"kernel_params.json\00", align 1
@.str.37 = private unnamed_addr constant [77 x i8] c"[OFFSET] CUPTI Timestamp: %lu, CPU Timestamp #1: %lu, CPU Timestamp #2: %lu\0A\00", align 1
@__const._Z23collectTimestampOffsetsv.sleepTime = private unnamed_addr constant %struct.timespec { i64 0, i64 10000000 }, align 8
@.str.38 = private unnamed_addr constant [26 x i8] c"[KERNEL] Start Time: %lu\0A\00", align 1
@.str.39 = private unnamed_addr constant [24 x i8] c"[KERNEL] End Time: %lu\0A\00", align 1
@.str.40 = private unnamed_addr constant [24 x i8] c"[KERNEL] Duration: %lu\0A\00", align 1
...
define dso_local void @madsen_function(ptr noundef %0, ptr noundef %1) #1 personality ptr @__gxx_personality_v0 {
  ...
  store ptr @.str.35, ptr %99, align 8
...
51:                                               ; preds = %26
  ...
  %53 = call noundef i32 @_ZL10cudaMallocIfE9cudaErrorPPT_m(ptr noundef %8, i64 noundef %52)
  %54 = load i64, ptr %3, align 8
  %55 = call noundef i32 @_ZL10cudaMallocIfE9cudaErrorPPT_m(ptr noundef %9, i64 noundef %54)
  %56 = load i64, ptr %3, align 8
  %57 = call noundef i32 @_ZL10cudaMallocIfE9cudaErrorPPT_m(ptr noundef %10, i64 noundef %56)
  %58 = load ptr, ptr %8, align 8
  %59 = load ptr, ptr %4, align 8
  %60 = load i64, ptr %3, align 8
  %61 = call i32 @cudaMemcpy(ptr noundef %58, ptr noundef %59, i64 noundef %60, i32 noundef 1)
  %62 = load ptr, ptr %9, align 8
  %63 = load ptr, ptr %5, align 8
  %64 = load i64, ptr %3, align 8
  %65 = call i32 @cudaMemcpy(ptr noundef %62, ptr noundef %63, i64 noundef %64, i32 noundef 1)
  %66 = call i32 (ptr, ...) @printf(ptr noundef @.str.31, i32 noundef 10000000)
  ...
  call void @_ZN4dim3C2Ejjj(ptr noundef nonnull align 4 dereferenceable(12) %13, i32 noundef %73, i32 noundef 1, i32 noundef 1)
  %74 = load i32, ptr %11, align 4
  call void @_ZN4dim3C2Ejjj(ptr noundef nonnull align 4 dereferenceable(12) %14, i32 noundef %74, i32 noundef 1, i32 noundef 1)
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %15, ptr align 4 %13, i64 12, i1 false)
  %75 = getelementptr inbounds { i64, i32 }, ptr %15, i32 0, i32 0
  %76 = load i64, ptr %75, align 4
  %77 = getelementptr inbounds { i64, i32 }, ptr %15, i32 0, i32 1
  %78 = load i32, ptr %77, align 4
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %16, ptr align 4 %14, i64 12, i1 false)
  %79 = getelementptr inbounds { i64, i32 }, ptr %16, i32 0, i32 0
  %80 = load i64, ptr %79, align 4
  %81 = getelementptr inbounds { i64, i32 }, ptr %16, i32 0, i32 1
  %82 = load i32, ptr %81, align 4
  %83 = call i32 @__cudaPushCallConfiguration(i64 %76, i32 %78, i64 %80, i32 %82, i64 noundef 0, ptr noundef null)
  %84 = icmp ne i32 %83, 0
...
85:                                               ; preds = %51
  ...
  call void @_Z25__device_stub__vector_addPfS_S_i(ptr noundef %86, ptr noundef %87, ptr noundef %88, i32 noundef %89) #19
  br label %90
...
90:                                               ; preds = %85, %51
  ...
  %94 = call i32 @cudaMemcpy(ptr noundef %91, ptr noundef %92, i64 noundef %93, i32 noundef 2)
  call void @_Z17flushCUPTIBuffersv()
  call void @_Z17printKernelTimingv()
  %95 = load ptr, ptr %8, align 8
  %96 = call i32 @cudaFree(ptr noundef %95)
  %97 = load ptr, ptr %9, align 8
  %98 = call i32 @cudaFree(ptr noundef %97)
  %99 = load ptr, ptr %10, align 8
  %100 = call i32 @cudaFree(ptr noundef %99)
...
11:                                               ; preds = %8
  ...
  %30 = call i32 (ptr, ...) @printf(ptr noundef @.str.37, i64 noundef %27, i64 noundef %28, i64 noundef %29)
...
3:                                                ; preds = %0
  ...
  %5 = call i32 (ptr, ...) @printf(ptr noundef @.str.38, i64 noundef %4)
  %6 = load i64, ptr @_ZL8end_time, align 8
  %7 = call i32 (ptr, ...) @printf(ptr noundef @.str.39, i64 noundef %6)
  %8 = load i64, ptr @_ZL15kernel_duration, align 8
  %9 = call i32 (ptr, ...) @printf(ptr noundef @.str.40, i64 noundef %8)
  br label %10
