...
// Independent pair: mul.lo.s32 -> add.s32
// Multiply and add operate on completely separate registers.
// Baseline for the dependent variant to isolate the cost of the RAW dependency.
...
int main()
{
    ...
    printf("[LOG] pair_mul_s32_add_s32_indep: %d iterations, indep pair\n", ITERATIONS);
