...
sgemmResolveBankConflicts(int M, int N, int K, float alpha,
                          float *A, float *B, float beta,
                          float *C) {

  META_BEGIN_KERNEL(sgemmResolveBankConflicts);
  ...
  META_ASSUME("Bs linearized to eliminate bank conflicts");
  ...
  META_END_KERNEL(sgemmResolveBankConflicts);
}