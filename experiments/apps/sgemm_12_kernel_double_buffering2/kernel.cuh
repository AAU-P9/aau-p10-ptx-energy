...
__global__ void __launch_bounds__(NUM_THREADS)
  ...
  META_BEGIN_KERNEL(runSgemmDoubleBuffering2);
  ...
  META_TILE(DIM_X, 128);
  META_LAUNCH(128, 1, 1, "CEIL_DIV(N,BN) CEIL_DIV(M,BM) 1");
  ...
  META_ASSUME("NUM_THREADS == 128 && BM == 128 && BN == 128 && BK == 16");
  META_ASSUME("double-buffered SMEM via cuda::barrier and memcpy_async");
  ...
  META_END_KERNEL(runSgemmDoubleBuffering2);
}